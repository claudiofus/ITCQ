...
class DataSource(categories : List<String>, val context : Context)
{
	...
	private fun drawableForLabel(category : String) : Drawable
	{
		...
		when (category)
		{
			...
			"Network", "Reti"                    -> drawable = getDrawable(context, R.drawable.ic_network)
			"Data structures", "Strutture dati"  -> drawable = getDrawable(context, R.drawable.ic_data_structure)
			"Server software", "Software server" -> drawable = getDrawable(context, R.drawable.ic_server)
			"Tools", "Strumenti"                 -> drawable = getDrawable(context, R.drawable.ic_tools)
			"Security", "Sicurezza"              -> drawable = getDrawable(context, R.drawable.ic_security)
			"Programming", "Programmazione"      -> drawable = getDrawable(context, R.drawable.ic_programming)
			"History", "Storia"                  -> drawable = getDrawable(context, R.drawable.ic_history)
			"Virtualization", "Virtualizzazione" -> drawable = getDrawable(context, R.drawable.ic_virtualization)
			"Version control", "Controllo delle versioni"  -> drawable = getDrawable(context, R.drawable.ic_merge)
		}
